const _reusableBaseText = { "cancel": "取消", "codeNodeEditor": { "linter": { "useJson": "访问 `.json` 下的项目属性，例如 `item.json`" }, "completer": { "all": "返回节点输出项的数组", "first": "返回节点输出的第一个项目", "last": "返回节点输出的最后一个项目", "itemMatching": "返回匹配的项目，即用于在指定索引处生成当前节点中项目的项目。" } }, "name": "名称", "save": "保存", "dismiss": "忽略", "unlimited": "无限", "activate": "激活", "error": "错误" };
...
const zhCN = {
  ...
  "credentialEdit.credentialInfo.created": "已创建",
  ...
  "credentialEdit.docs.aws": '配置此凭证：\n\n- 选择您的 AWS **区域**。\n- 登录您的 <a href="https://aws.amazon.com/" target="_blank">AWS</a> 帐户。\n- 生成您的访问密钥对：\n  - 打开 AWS <a href="https://console.aws.amazon.com/iam" target="_blank">IAM 控制台</a>并打开您的用户菜单。\n  - 选择“**安全凭证**”。\n  - 在“**访问密钥**”部分中创建一个新的访问密钥对。\n  - 显示“**访问密钥 ID**”和“**秘密访问密钥**”，并将它们输入到 n8n 中。\n- 要使用“**临时安全凭证**”，请打开此选项并添加“**会话令牌**”。\n- 如果您使用 Amazon Virtual Private Cloud <a href="https://aws.amazon.com/vpc/" target="_blank">VPC</a> 来托管 n8n，您可以在 VPC 和某些应用之间建立连接。使用“**自定义端点**”为此连接输入相关的自定义端点。\n\n点击上面的文档链接获取更多详细说明。',
  "credentialEdit.docs.gmailOAuth2": '配置此凭证：\n\n- 登录您的 <a href="https://cloud.google.com/" target="_blank">Google Cloud</a> 帐户。\n- 转到 <a href="https://console.cloud.google.com/apis/credentials" target="_blank">Google Cloud Console / API 和服务</a>，然后从左上角的选择中选择要使用的项目（或创建一个新项目并将其选中）。\n- 如果您以前没有在此 Google Cloud 项目中使用过 OAuth，请<a href="https://developers.google.com/workspace/guides/configure-oauth-consent" target="_blank">配置 OAuth 同意屏幕</a>。\n- 在“凭证”中，选择“**+ 创建凭证 > OAuth 客户端 ID**”。\n- 在“**应用程序类型**”下拉菜单中，选择“**Web 应用程序**”。\n- 在“**授权重定向 URI**”下，选择“**+ 添加 URI**”。粘贴来自 n8n 的 OAuth 重定向 URL。\n- 选择“**创建**”。\n- 在“已启用的 API 和服务”中，选择“**+ 启用 API 和服务**”。\n- 选择并启用 Gmail API。\n- 返回“凭证”，单击“OAuth 2.0 客户端 ID”中的凭证，在凭证页面上，您将找到客户端 ID 和客户端密钥。\n\n点击上面的文档链接获取更多详细说明。',
  "credentialEdit.docs.openAiApi": '配置此凭证：\n\n- 登录您的 <a href="https://platform.openai.com/login" target="_blank">OpenAI</a> 帐户。\n- 打开您的 OpenAI <a href="https://platform.openai.com/api-keys" target="_blank">API 密钥</a>页面以创建“**API 密钥**”。\n- 如果您属于多个组织，请输入“**组织 ID**”；否则，请留空。打开您的 OpenAI <a href="https://platform.openai.com/account/organization" target="_blank">组织设置</a>页面以获取您的组织 ID。\n\n点击上面的文档链接获取更多详细说明。',
  ...
  "credentials.item.updated": "上次更新时间",
  "credentials.item.created": "已创建",
  ...
  "dataMapping.schemaView.emptyDataWithBinary": "仅存在二进制数据。请使用“二进制”标签页查看。",
  "dataMapping.schemaView.executeSchema": "{链接}查看架构",
  "dataMapping.schemaView.disabled": "此节点已禁用，将仅传递数据",
  "dataMapping.schemaView.noMatches": "没有与“{search}”匹配的结果",
  "dataMapping.schemaView.preview": "通常输出以下字段。执行节点以查看实际内容。{链接}",
  ...
  "folders.delete.action": "删除所有工作流程及子文件夹",
  "folders.delete.error.message": "删除文件夹时出现问题",
  "folders.delete.confirmation.message": "输入“delete {文件夹名称}”以确认",
  ...
  "folders.move.modal.description": "注意：移动此文件夹将同时移动其中的所有工作流程和子文件夹。",
  "folders.move.modal.select.placeholder": "搜索文件夹",
  "folders.move.modal.confirm": "移至文件夹",
  ...
  "folders.move.project.root.name": "{项目名称}（项目根目录）",
  ...
  "logs.overview.body.summaryText": "{status}于{time}",
  "logs.overview.body.started": "开始于{time}",
  "logs.overview.body.run": "测试步骤",
  ...
  "mainSidebar.confirmMessage.workflowDelete.message": "是否确定要删除“{workflowName}”？",
  ...
  "ndv.execute.generatingCode": "正在从说明生成代码",
  ...
  "ndv.output.waitNodeWaitingForWebhook": "在收到 Webhook 时，执行将继续 ",
  "ndv.output.githubNodeWaitingForWebhook": "在调用以下Webhook URL时，执行将继续：",
  "ndv.output.sendAndWaitWaitingApproval": "执行将在用户响应后继续",
  "ndv.output.waitNodeWaitingForFormSubmission": "当在以下位置提交表单时，执行将继续 ",
  "ndv.output.waitNodeWaiting": "等待时间结束后，执行将继续",
  ...
  "nodeCreator.triggerHelperPanel.workflowTriggerDisplayName": "当被另一个工作流调用时",
  ...
  "nodeCreator.aiPanel.selectAiNode": "选择 AI 节点以添加到您的工作流",
  ...
  "ndv.trigger.webhookBasedNode.executionsHelp.inactive": '<b>在构建您的工作流时</b>，单击“侦听”按钮，然后转到 {service} 并使事件发生。这将触发执行，该执行将显示在此编辑器中。<br /> <br /> <b>当您对您的工作流感到满意时</b>，<a data-key="activate">激活</a> 它。然后，每次 {service} 中发生匹配事件时，工作流都会执行。这些执行将显示在<a data-key="executions">执行列表</a>中，而不是编辑器中。',
  "ndv.trigger.webhookBasedNode.executionsHelp.active": '<b>在构建您的工作流时</b>，单击“侦听”按钮，然后转到 {service} 并使事件发生。这将触发执行，该执行将显示在此编辑器中。<br /> <br /> <b>您的工作流也会自动执行</b>，因为它已激活。每次 {service} 中发生匹配事件时，此节点都会触发执行。这些执行将显示在 <a data-key="executions">执行列表</a>中，而不是编辑器中。',
  ...
  "workflowDetails.showMessage.message": "请输入名称，或按“esc”键返回旧名称",
  ...
  "workflows.item.updated": "上次更新时间",
  "workflows.item.created": "已创建",
  ...
  "settings.sso.settings.ips.url.help": "在此处粘贴 Internet 提供商元数据 URL",
  ...
  "projects.header.subtitle": "您有权访问的所有工作流、凭据和执行",
  ...
  "communityPlusModal.features.fourth.description": "以嵌套文件夹结构组织您的工作流程",
  ...
  "testDefinition.edit.backButtonTitle": "返回工作流评估",
  "testDefinition.edit.namePlaceholder": "输入测试名称",
  "testDefinition.edit.selectTag": "选择标签...",
  "testDefinition.edit.tagsHelpText": "具有此标签的执行将作为测试用例添加到此测试。",
  "testDefinition.edit.workflowSelectorLabel": "用于进行比较的工作流",
  "testDefinition.edit.workflowSelectorDisplayName": "工作流",
  "testDefinition.edit.workflowSelectorTitle": "用于进行比较的工作流",
  "testDefinition.edit.workflowSelectorHelpText": "将为每个测试用例调用此工作流。",
  "testDefinition.edit.updateTest": "更新测试",
  "testDefinition.edit.saveTest": "运行测试",
  ...
  "testDefinition.edit.description.description": "补充说明该测试评估的内容以及成功标准",
  "testDefinition.edit.pinNodes.noNodes.title": "没有可供固定的节点",
  "testDefinition.edit.pinNodes.noNodes.description": "您的工作流程需要至少包含一个节点才能运行测试。",
  "testDefinition.edit.tagName": "标签名称",
  "testDefinition.edit.step.intro": "运行测试时",
  "testDefinition.edit.step.executions": "获取过去的 5 次执行",
  "testDefinition.edit.step.tag": "获取所有标记为{tag}的历史执行记录",
  "testDefinition.edit.step.tag.placeholder": "输入新标签名称",
  "testDefinition.edit.step.tag.validation.required": "标签名称是必填项",
  "testDefinition.edit.step.tag.validation.tooLong": "标签名称过长",
  "testDefinition.edit.step.executions.tooltip": "过往的执行记录被用作基准数据。在测试过程中，每项记录都将重新执行以检测性能是否发生变化。",
  "testDefinition.edit.step.mockedNodes": "未模拟任何节点 | 已模拟 {count} 个节点 | 已模拟 {count} 个节点",
  "testDefinition.edit.step.nodes.tooltip": "模拟节点会重放其数据而非重新执行。这样做是为了避免调用外部服务，或节省执行时间。",
  "testDefinition.edit.step.reRunExecutions": "重新运行执行",
  "testDefinition.edit.step.reRunExecutions.tooltip": "每次过往的执行都将使用待测试工作流程的最新版本重新运行。",
  "testDefinition.edit.step.compareExecutions": "比较每次过去和新的执行",
  "testDefinition.edit.step.compareExecutions.tooltip": "每次过去的执行都会被拿来与其新的对应版本进行比较，以检查它们的相似度。这一过程通过独立的评估工作流实现：该工作流接收两个执行版本作为输入，并输出相应的指标度量。",
  "testDefinition.edit.step.collapse": "折叠",
  "testDefinition.edit.step.configure": "配置",
  "testDefinition.edit.selectNodes": "将节点固定以进行模拟",
  "testDefinition.edit.modal.description": "重新运行执行时，选择保留哪些过往数据。所有模拟节点将被回放而非重新执行。触发器始终保持模拟状态。",
  "testDefinition.edit.runExecution": "运行执行",
  "testDefinition.edit.pastRuns": "过往运行记录",
  "testDefinition.edit.pastRuns.total": "未运行 | 上次运行 | 历史运行",
  "testDefinition.edit.nodesPinning.pinButtonTooltip": "在评估执行过程中使用该节点的基准数据",
  "testDefinition.edit.nodesPinning.pinButtonTooltip.pinned": "该节点将不会重新执行",
  "testDefinition.edit.nodesPinning.triggerTooltip": "默认情况下，触发器节点会被模拟",
  ...
  "testDefinition.list.unitTests.badge": "即将推出",
  "testDefinition.list.unitTests.title": "单元测试",
  "testDefinition.list.unitTests.description": "通过检查特定条件来验证工作流逻辑",
  "testDefinition.list.unitTests.cta": "注册意向",
  "testDefinition.list.createNew": "创建新测试",
  "testDefinition.list.runAll": "运行所有评估",
  "testDefinition.list.actionDescription": "重放过去的执行以检查性能是否发生变化",
  "testDefinition.list.actionButton": "创建测试",
  "testDefinition.list.actionButton.unregistered": "解锁评估",
  "testDefinition.list.actionDescription.registered": "您的计划允许进行一次评估。",
  "testDefinition.list.actionDescription.unregistered": "注册即可解锁免费测试",
  "testDefinition.list.actionDescription.atLimit": "您已达到评估次数限制，升级后可继续使用更多功能",
  "testDefinition.list.testRuns": "无测试运行 | {count} 次测试运行 | {count} 次测试运行",
  "testDefinition.list.lastRun": "运行时间：{lastRun}",
  "testDefinition.list.running": "跑步",
  "testDefinition.list.errorRate": "错误率：{errorRate}",
  "testDefinition.list.testStartError": "测试运行启动失败",
  "testDefinition.list.testStarted": "测试运行已开始",
  "testDefinition.list.testCancelled": "测试运行已取消",
  "testDefinition.list.loadError": "加载测试失败",
  "testDefinition.list.item.tests": '无测试用例 | {count} 个测试用例 | {count} 个测试用例\n\n注：根据中文习惯简化了复数表达形式，中文通常不使用复数形态变化，而是通过量词"个"和上下文自然体现单复数概念。译文采用统一格式"{count} 个测试用例"兼顾单复数场景，符合中文"一即多"的语言特性。专业术语"test case"采用通用译法"测试用例"，保持技术文档的准确性。竖线分隔符保留原格式，便于程序识别多语言字符串中的不同条件分支。',
  "testDefinition.list.item.missingFields": "无字段缺失 | {count} 个字段缺失 | {count} 个字段缺失",
  "testDefinition.listRuns.status.new": "新",
  "testDefinition.listRuns.status.running": "跑步",
  "testDefinition.listRuns.status.evaluating": "评估",
  ...
  "testDefinition.listRuns.runNumber": "跑",
  "testDefinition.listRuns.runDate": "运行日期",
  "testDefinition.listRuns.runStatus": "运行状态",
  "testDefinition.listRuns.noRuns": "无测试运行",
  "testDefinition.listRuns.noRuns.description": "在此处运行测试以查看结果",
  "testDefinition.listRuns.deleteRuns": '没有运行记录可删除 | 删除 {count} 条运行记录 | 删除 {count} 条运行记录\n\n（注：根据中文语言习惯，单复数形式通常不做区分，因此三种情况统一译为"删除X条运行记录"。若需强调单数情况，可调整为：\n无运行可删除 | 删除1条运行 | 删除{count}条运行）',
  "testDefinition.listRuns.noRuns.button": "运行测试",
  "testDefinition.listRuns.error.noPastExecutions": "未向指定标签添加执行项",
  "testDefinition.listRuns.error.evaluationWorkflowNotFound": "所选评估工作流程不存在。{链接}。",
  "testDefinition.listRuns.error.evaluationWorkflowNotFound.solution": "修复测试配置",
  "testDefinition.runDetail.ranAt": "跑在",
  "testDefinition.runDetail.testCase": "测试用例",
  "testDefinition.runDetail.testCase.id": "测试用例ID",
  "testDefinition.runDetail.testCase.status": "测试用例状态",
  "testDefinition.runDetail.totalCases": "总病例数",
  "testDefinition.runDetail.error.mockedNodeMissing": "基准测试执行中不存在模拟节点的输出。{链接}",
  "testDefinition.runDetail.error.mockedNodeMissing.solution": "修复测试配置",
  "testDefinition.runDetail.error.executionFailed": "未能执行带有基准触发器的工作流。{链接}。",
  "testDefinition.runDetail.error.executionFailed.solution": "查看执行",
  "testDefinition.runDetail.error.evaluationFailed": "执行评估工作流失败。{链接}。",
  "testDefinition.runDetail.error.evaluationFailed.solution": "查看评估执行情况",
  "testDefinition.runDetail.error.triggerNoLongerExists": "基准测试执行中的触发器在工作流中已不存在。{链接}",
  "testDefinition.runDetail.error.triggerNoLongerExists.solution": "查看基准测试",
  "testDefinition.runDetail.error.invalidMetrics": "评估工作流返回了无效的指标值，仅接受数值类型数据。请查看评估执行详情：{链接}。",
  "testDefinition.runDetail.error.invalidMetrics.solution": "查看评估执行",
  "testDefinition.runTest": "运行测试",
  "testDefinition.cancelTestRun": "取消测试运行",
  "testDefinition.notImplemented": "此功能尚未实现！",
  "testDefinition.viewDetails": "查看详细信息",
  "testDefinition.editTest": "编辑测试",
  "testDefinition.deleteTest": "删除测试",
  "testDefinition.deleteTest.warning": "测试及其所有相关运行记录将被删除，此操作不可撤销。",
  "testDefinition.testIsRunning": "测试正在进行中，请等待完成。",
  "testDefinition.completeConfig": "完成以下配置以运行测试：",
  "testDefinition.configError.noEvaluationTag": "未设置评价标签",
  "testDefinition.configError.noExecutionsAddedToTag": "此标签下未添加任何执行",
  "testDefinition.configError.noEvaluationWorkflow": "未设置评估流程",
  "testDefinition.configError.noMetrics": "未设置指标",
  "testDefinition.workflowInput.subworkflowName": "{name}的评估流程",
  "testDefinition.workflowInput.subworkflowName.default": "我的评估子工作流",
  "testDefinition.executions.addTo": "添加到测试",
  "testDefinition.executions.addTo.new": "添加到测试",
  ...
  "testDefinition.executions.removedFrom": "从“{name}”中移除执行",
  "testDefinition.executions.toast.addedTo": "返回至“{name}”",
  "testDefinition.executions.tooltip.addTo": "添加到新测试",
  "testDefinition.executions.tooltip.noExecutions": "评估执行无法添加到测试中",
  "testDefinition.executions.tooltip.onlySuccess": "只有执行成功的案例才能被添加到测试中",
  "testDefinition.workflow.createNew": "创建新的评估工作流程",
  "testDefinition.workflow.createNew.or": "或使用现有的评估子工作流程",
  "testDefinition.executions.toast.addedTo.title": "测试中添加了执行项",
  "testDefinition.executions.toast.closeTab": "关闭此标签页",
  "testDefinition.executions.toast.removedFrom.title": "测试中移除执行",
  ...
  "insights.banner.noData": "收集中...",
  "insights.banner.noData.tooltip": "指标数据最长可能需要24小时才会显示。如果您刚刚更新或开始使用n8n，请稍后再来查看。",
  ...
  "insights.dashboard.paywall.cta": "升级",
